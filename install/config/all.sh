...
run_logged $OMARCHY_INSTALL/config/reaper.sh
...
run_logged $OMARCHY_INSTALL/config/firefox-extensions.sh
run_logged $OMARCHY_INSTALL/config/chromium-extensions.sh
