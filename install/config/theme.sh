...
ln -snf ~/.config/omarchy/themes/factorio ~/.config/omarchy/current/theme
ln -snf ~/.config/omarchy/current/theme/backgrounds/factorio.jpg ~/.config/omarchy/current/background
